...
namespace SharpTS.Core
{
    ...
    internal class Window
    {
        ...
        {
            this.messageBroker.On<MessageEventArgs<DataMessage<FrameLoadMessageData>>>(
                MessageType.NewFrame, 
                args => this.NewFrame(args.Cast<DataMessage<FrameLoadMessageData>>())
                );
        }
        ...
        /// <returns></returns>
        private Task NewFrame(MessageEventArgs<DataMessage<FrameLoadMessageData>> args)
        {
            try
            {
                ...
                string frameName = args.Message.Data.FrameName;
